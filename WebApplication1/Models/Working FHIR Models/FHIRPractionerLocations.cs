...
namespace WebApplication1.Models
{
  ...
  //[DataContract]
  [Table("FHIRPractionerLocation")]
  public partial class FHIRPractionerLocation
  {
...
//    [ForeignKey("FHIRPractitioners")]
    ...
    //public ICollection<FHIRLocation> FHIRLocations { get; set; }

    //[XmlIgnore]
    //[DisplayName("Practitioners")]
    //public ICollection<FHIRPractitioner> FHIRPractitioners { get; set; }
