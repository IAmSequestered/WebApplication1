...
namespace WebApplication1.Models
{
  ...
  public partial class FHIRPractitioner
  {
   ...
   // [DataMember]
    ...
    [XmlIgnore]
    public ICollection<FHIRPractionerLocation> PractitionerLocations { get; set; }

    //public virtual ICollection<FHIRPractitionerType> PractitionerTypes { get; set; }
